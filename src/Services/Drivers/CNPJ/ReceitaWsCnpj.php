...
class ReceitaWsCnpj  extends ServiceCnpj
{
    ...
    {
        return $data['atividade_principal'][0]['code'] ?? null;
    }

    protected static function cnaeDescription($data): ?string
    {
        return $data['atividade_principal'][0]['text'] ?? null;
    }
